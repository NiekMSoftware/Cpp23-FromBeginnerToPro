// Ex2_02.cpp -  Converting distances
#include "pch.h"
...
int main() {
	...
	std::print("Enter a distance in yards, feet, and inches to inches ");
	...
	std::println("This distance corresponds to {} yards, {} feet and {} inches.",
		yards, feet, inches);
	return 0;
}